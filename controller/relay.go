...
func executeTaskSubmissionWith(
	...
	consumeParams := service.BuildTaskConsumeLogParams(c, relayInfo, task)
	if settleErr := service.SettleBilling(c, relayInfo, result.Quota, consumeParams); settleErr != nil {
	...
	service.LogTaskConsumptionWithParams(c, relayInfo, consumeParams)
